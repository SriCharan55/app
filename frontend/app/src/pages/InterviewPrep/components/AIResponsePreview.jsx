            ...
            <div className="text-[14px] prose prose-slate dark:prose-invert max-w-none">
                <ReactMarkdown
                    ...
                    components={{
                        ...
                        blockquote({ children }) {
                            return (
                                <blockquote className="border-l-4 border-gray-200 pl-4 italic my-4 text-gray-600 dark:text-gray-300">
                                    {children}
                                </blockquote>
                            );
                        },
                        ...
                        td({ children }) {
                            return (
                                <td className="px-3 py-2 border-t whitespace-nowrap text-sm">
                                    {children}
                                </td>
                            );
                        },
                        ...
                        img({ src, alt }) {
                            return (
                                <img
                                    src={src}
                                    alt={alt}
                                    className="my-4 max-w-full rounded shadow-sm"
                                />
                            );
                        },
                    }}
    ...
    return (
        <div className="relative my-6 rounded-lg overflow-hidden bg-gray-50 border border-gray-200">
            ...
            <SyntaxHighlighter
                language={language}
                style={oneLight}
                customStyle={{ fontSize: 14, margin: 0, padding: '1rem', background: 'transparent' }}
            >
                {code}
            </SyntaxHighlighter>
        </div>
