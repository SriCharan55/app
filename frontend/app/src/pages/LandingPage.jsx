...
const LandingPage = () => {
  ...
  <div className="container mx-auto max-w-7xl px-4 pt-6 pb-[80px] relative z-10">
          {/* Header */}
          ...
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="w-full md:w-1/2 pl-8 flex flex-col items-start">
              ...
              <button className="bg-black text-white px-6 py-2 rounded-full mt-6 shadow-md hover:opacity-95" onClick={handleCTA} type="button">
                Get Started
              </button>
            </div>
          </div>
  ...
  <section className="container mx-auto max-w-7xl px-4 flex items-center justify-center -mt-[60px] md:-mt-[100px] lg:-mt-[140px]">
          <img src={hero} alt="Hero Image" className="w-full max-w-[1100px] rounded-2xl border-2 border-amber-200 p-2 shadow-lg bg-white" />
        </section>
